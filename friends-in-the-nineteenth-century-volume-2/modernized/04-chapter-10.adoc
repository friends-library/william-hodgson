...
R+++.+++ M.--"`I have been told that on Fifth-day at the North
...
R+++.+++ M.--"`Christopher, there is a shyness between you and me,
...
Amos 1 not what I always was since you first knew me, the same in sentiment,
the same in doctrine, the same in love and zeal for the Truth?`"

R+++.+++ M.--"`I do not accuse you of having changed.`"

C+++.+++ H.--"`Well then, Richard, if I have not changed, you must have done so,
