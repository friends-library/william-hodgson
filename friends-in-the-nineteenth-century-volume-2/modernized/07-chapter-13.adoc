...
and particularly mentioning the Philadelphia _Appeal for the Ancient Doctrines,
and the Report on the Division in New England,_ as setting forth the matter,
