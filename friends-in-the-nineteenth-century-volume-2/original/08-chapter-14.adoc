...
viz.: David Cope, Samuel Cope, Moses Bailey, William N. Scarlet, Solomon Lukens,
...
If in those +++[+++primitive]
days there was no concord between light and darkness, between truth and error,
why should there now be?
...
To whom this language was addressed: "`I know thy works,
...
14.]
which appeared to him not to have been written with
Joseph Hoag`'s wonted clearness from external bias,
...
the reader might refer to an address from
New York Yearly Meeting of Friends +++[+++King party+++]+++,
1859; also, [.book-title]#Some Things Set Forth for the Clearing of Truth,
By Way of Reply to the Former,# Auburn, 1859; [.book-title]#An Exposition, etc.,
...
when assembled in that capacity, should be, together with their clerk,
probably +++[+++palpably]
unsound,
...
while endeavoring to avoid the only justification of such action, viz.,
...
The idea of Charles Evans in regard to "`one Society of Friends with two organizations,`"
is too preposterous to be soberly entertained by any one,
