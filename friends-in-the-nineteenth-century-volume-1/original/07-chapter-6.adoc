...
and its coadjutors both in and outside of the Society, entitled, [.book-title]#Truth Vindicated,# etc.,
...
and rather materially promoted than in any wise damaged, the cause of the [.book-title]#Beacon;#
...
He soon published a reply to J. J. Gurney`'s [.book-title]#Strictures,#
...
but he "`still more highly disapproved of Dr. Hancock`'s reply`" +++[+++_Defence_],
...
and I can cordially endorse the following expressions,
...
or as he entitled it when printed as a pamphlet, his [.book-title]#Defence of the Beacon;#
...
is μαρτυρίαν (testimony), and the verb translated _gave_ is μεμαρτύρνχεν (hath testified),
