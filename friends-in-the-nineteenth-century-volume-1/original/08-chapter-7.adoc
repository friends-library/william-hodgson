...
footnote:[See _S. Alexander`'s Voice from the Wilderness,_ pages 40 to 43; also,
_Life of Sarah Grubb, Late Lynes,_ Eng. edit+++.+++, p. 333.]
...
footnote:[_Stephens`'s Report of London Yearly Meeting._ 1836, page 18.]
...
[.discourse-part]
He considered that the saving knowledge of God was
to be obtained only through the Scriptures--though
...
[.discourse-part]
That the righteousness of Christ is imputed to believers in Him--to
"`whosoever places his reliance on him as the atonement for sin,`"
even though "`vile and polluted`" with sin;
...
footnote:[_Memoirs of D. Wheeler, London,_ 1842, p. 691.]
